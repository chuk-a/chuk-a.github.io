...
const PARTS_LIST = [
    { id: 'lcd', name: 'Replacement LCD Screen Display', description: 'Шинэ өндөр чанартай дэлгэц. Гэрэлтүүлэг болон өнгөний нягтрал сайтай.', price: 110000, category: 'parts' },
    ...
    { id: 'shipping', name: 'Тээвэр (Shipping)', description: 'Хот доторх хүргэлт эсвэл орон нутгийн унаанд тавьж өгөх үйлчилгээ.', price: 15000, category: 'service' },
